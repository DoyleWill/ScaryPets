...
def launch_controller(on_button1, on_button2, on_button3, on_button4, on_button5):
  ...
  tk.Button(root, text="Button 1", width=20, height=2, command=on_button2).pack(pady=5)
  ...
  tk.Button(root, text="Button 5", width=20, height=2, command=on_button5).pack(pady=5)
